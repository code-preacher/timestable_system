            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-home"></i><span class="hide-menu">All Level </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="nd1.php">ND 1 </a></li>
                                <li><a href="nd2.php">ND 2 </a></li>
                                <li><a href="hnd1.php">HND 1</a></li>
                                <li><a href="hnd2.php">HND 2</a></li>
                            </ul>
                        </li>
