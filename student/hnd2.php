                              ...
                              <input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  placeholder="Search for day....."  required>
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-hover table-bordered ">
                                        ...
                                        <tbody>
<?php
$a1=mysqli_query($con,"select * from data where level='hnd2' and semester='first' and day='monday' ");
...
?>  
  ...
  <?php
$a2=mysqli_query($con,"select * from data where level='hnd2' and semester='first' and day='tuesday' ");
...
?>  
 ...
 <?php
$a3=mysqli_query($con,"select * from data where level='hnd2' and semester='first' and day='wednesday' ");
...
?>  
                                   ...
                                   <?php
$a4=mysqli_query($con,"select * from data where level='hnd2' and semester='first' and day='thursday' ");
...
?>  
   ...
   <?php
$a5=mysqli_query($con,"select * from data where level='hnd2' and semester='first' and day='friday' ");
                              ...
                              <input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  placeholder="Search for day....."  required>
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-hover table-bordered ">
                                        ...
                                        <tbody>
<?php
$a6=mysqli_query($con,"select * from data where level='hnd2' and semester='second' and day='monday' ");
...
?>  
  ...
  <?php
$a7=mysqli_query($con,"select * from data where level='hnd2' and semester='second' and day='tuesday' ");
...
?>  
 ...
 <?php
$a8=mysqli_query($con,"select * from data where level='hnd2' and semester='second' and day='wednesday' ");
...
?>  
                                   ...
                                   <?php
$a9=mysqli_query($con,"select * from data where level='hnd2' and semester='second' and day='thursday' ");
...
?>  
   ...
   <?php
$a20=mysqli_query($con,"select * from data where level='hnd2' and semester='second' and day='friday' ");
