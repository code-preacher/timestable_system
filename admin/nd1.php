                                          ...
                                          <td><?php echo $a11['time3'];  ?></td>
                                           <td><?php echo $a11['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a11['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a11['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a12['time3'];  ?></td>
                                           <td><?php echo $a12['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a12['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a12['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a13['time3'];  ?></td>
                                           <td><?php echo $a13['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a13['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a13['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a14['time3'];  ?></td>
                                           <td><?php echo $a14['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a14['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a14['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a15['time3'];  ?></td>
                                           <td><?php echo $a15['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a15['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a15['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a16['time3'];  ?></td>
                                           <td><?php echo $a16['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a16['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a16['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a17['time3'];  ?></td>
                                           <td><?php echo $a17['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a17['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a17['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a18['time3'];  ?></td>
                                           <td><?php echo $a18['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a18['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a18['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a19['time3'];  ?></td>
                                           <td><?php echo $a19['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a19['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a19['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
                                          ...
                                          <td><?php echo $a20['time3'];  ?></td>
                                           <td><?php echo $a20['time4'];  ?></td>
                                            <td><a href="edit.php?id=<?php echo $a20['id']?>" onClick="return confirm('Are you sure you want to edit this data ?')"><i class="fa fa-pencil"></i></a></td>
                                                <td><a href="delete.php?id=<?php echo $a20['id']?>" onClick="return confirm('Are you sure you want to delete this data ?')"><i class="fa fa-bitbucket"></i></a></td>
